...
namespace SDL {
    ...
    public:
        ...
        void renderGeometry(SDL_Texture* texture, std::span<const SDL::Vertex> vertices, std::span<int> indices = {}) const noexcept;
        ...
        void renderTexture(const SDL::Texture& texture, const SDL::FRect& srcRect = {}, const SDL::FRect& destRect = {}) const noexcept;
        ...
        void setRenderTarget(const SDL::Texture& texture) const noexcept;
        void setRenderTarget() const noexcept;

        [[nodiscard]] SDL::Texture createTexture(SDL::PixelFormat format, SDL::TextureAccess access, int width, int height) const;
        [[nodiscard]] SDL::Texture createTextureFromSurface(const SDL::Surface& surface) const;
        [[nodiscard]] SDL::Texture createTextureWithProperties(SDL::PropertiesId properties) const;
